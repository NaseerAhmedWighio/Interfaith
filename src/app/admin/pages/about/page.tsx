            ...
            editSectionId === story.id ? (
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  ...
                  <button onClick={() => setEditSectionId(null)} className="flex items-center gap-1.5 px-4 py-2 bg-red-500/20 hover:bg-red-500/30 text-red-400 rounded-xl transition-colors text-sm font-medium"><X className="w-4 h-4" /> Cancel</button>
                </div>
              </div>
            ) : (
              <div className="space-y-3">
